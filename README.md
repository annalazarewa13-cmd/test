...
это техническая планка по номеру сборки. И она **разная** для двух продуктов:

- **Claude Code CLI** — Windows 10 1809, сборка **17763**
- **десктопное приложение** — Windows 10 2004, сборка **19041**

Установщик приложения проверяет версию жёстко и отказывает ниже 19041.
...
| Сборка | Версия | CLI | Приложение | PowerShell 7 |
|--------|--------|-----|------------|--------------|
| 10240  | LTSB 2015 | нет | нет | нет |
| 14393  | LTSB 2016 | нет | нет | да |
| 17763  | LTSC 2019 | да | **нет** | да |
| 19044  | LTSC 2021 | да | да | да |
| 26100  | Win 11 LTSC 2024 | да | да | да |

LTSC 2019 навсегда остаётся на 17763 — это свойство редакции, а не следствие
непоставленных обновлений. Для приложения нужна другая система.
